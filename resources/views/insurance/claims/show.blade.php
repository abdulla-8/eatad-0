...
<div class="bg-white rounded-xl shadow-sm border">
  ...
  <div class="p-6 space-y-4">
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div class="flex items-center justify-between bg-gray-50 rounded-lg p-4 border-l-4" style="border-color: {{ $company->primary_color }};">
        <div class="flex items-center gap-2">
          <!-- Icon: Policy Document -->
          <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" >
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
          <span class="text-gray-600 text-sm">{{ t($company->translation_group . '.user_policy') }}</span>
        </div>
    ...
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div class="flex items-center justify-between bg-gray-50 rounded-lg p-4 border-l-4" style="border-color: {{ $company->primary_color }};">
        <div class="flex items-center gap-2">
          ...
          <span class="text-gray-600 text-sm">{{ t($company->translation_group . '.policy_number') }}</span>
        </div>
      ...
      <div class="flex items-center justify-between bg-gray-50 rounded-lg p-4 border-l-4" style="border-color: {{ $company->primary_color }};">
        <div class="flex items-center gap-2">
          ...
          <span class="text-gray-600 text-sm">{{ t($company->translation_group . '.vehicle') }}</span>
        </div>
