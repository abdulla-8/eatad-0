    ...
    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between">
        <div class="flex items-center space-x-4 {{ $isRtl ? 'space-x-reverse' : '' }} mb-4 lg:mb-0">
            ...
            <div>
                ...
                <p class="text-white/80">{{ $company->legal_name }}</p>
            </div>
        </div>
        <div class="text-{{ $isRtl ? 'left' : 'right' }}">
            <p class="text-white/70 text-sm">{{ t($company->translation_group . '.my_profile', 'My Profile') }}</p>
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold" style="color: {{ $company->primary_color }};">{{ $stats['profile_completion'] }}%</p>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200 opacity-60">
                ...
                <span class="font-semibold text-gray-600">{{ t($company->translation_group . '.claims', 'Claims') }} (Coming Soon)</span>
            </div>
            ...
            <div class="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200 opacity-60">
                ...
                <span class="font-semibold text-gray-600">{{ t($company->translation_group . '.policies', 'Policies') }} (Coming Soon)</span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="p-6 space-y-4">
            ...
            @endif
            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                <span class="text-gray-600">Company Route</span>
                <span class="font-medium text-sm font-mono px-2 py-1 rounded" style="background: {{ $company->primary_color }}20; color: {{ $company->primary_color }};">{{ $company->company_slug }}</span>
            </div>
        </div>
    </div>
</div>
