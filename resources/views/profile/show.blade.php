                ...
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 mt-6 lg:mt-0">
                        ...
                        <button onclick="openPasswordModal()" 
                                class="inline-flex items-center px-6 py-3 bg-white text-gray-800 rounded-xl font-medium hover:bg-gray-50 transition-all duration-200 shadow-lg">
                            <svg class="w-5 h-5 mr-2 rtl:mr-0 rtl:ml-2" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                @foreach($profileData['display_fields'] as $field => $fieldData)
                                    <div class="group">
                                        ...
                                        <div class="bg-gray-50 rounded-xl p-4 border-2 border-gray-100 group-hover:border-gray-200 transition-colors duration-200">
                                            <span class="text-gray-900 font-medium">{{ $user->$field ?? 'غير محدد' }}</span>
                                        </div>
                                    </div>
                                @endforeach
                            @endif
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden mt-8">
                    <div class="border-b border-gray-200 px-8 py-6">
                        <h2 class="text-2xl font-bold text-gray-900 flex items-center">
                            ...
                            النشاطات الأخيرة
                            <span class="text-sm font-normal text-gray-500 mr-2 rtl:mr-0 rtl:ml-2">(الشكاوى والاستفسارات المرسلة)</span>
                        </h2>
                    </div>
                                ...
                                <div class="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 flex items-center mt-1">
                                            ...
                                            {{ isset($activity['date']) ? $activity['date']->format('d/m/Y H:i') : 'غير محدد' }}
                                        </p>
                                    </div>
                                    <span class="px-3 py-1 text-xs rounded-full font-medium {{ ($activity['status'] ?? '') === 'مقروءة' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                        @if(($activity['status'] ?? '') === 'مقروءة')
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 rounded-xl" style="background: linear-gradient(135deg, {{ $profileData['colors']['primary'] ?? '#3b82f6' }}10, {{ $profileData['colors']['primary'] ?? '#3b82f6' }}05);">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-700">إجمالي الفنيين</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-4 rounded-xl" style="background: linear-gradient(135deg, #10b98120, #10b98105);">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-700">فنيين نشطين</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-4 rounded-xl" style="background: linear-gradient(135deg, #f5973820, #f5973805);">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-700">فنيين غير نشطين</span>
                                </div>
                            ...
                            @if(isset($stats) && is_array($stats))
                                @foreach($stats as $key => $value)
                                    <div class="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                                        ...
                                        <span class="text-lg font-bold" style="color: {{ $profileData['colors']['primary'] ?? '#3b82f6' }}">{{ $value ?? 'غير محدد' }}</span>
                                    </div>
                                @endforeach
                            @endif
                        </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            ...
                            @endif
                                ...
                                <span class="text-gray-700 group-hover:text-gray-900 font-medium">عرض الشكاوى</span>
                                <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 mr-auto rtl:mr-0 rtl:ml-auto" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            @endif
                                ...
                                <span class="text-gray-700 group-hover:text-gray-900 font-medium">الرئيسية</span>
                                <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 mr-auto rtl:mr-0 rtl:ml-auto" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/>
                                </svg>
                            </a>
                            ...
                            @if($userType === 'insurance_company')
                                <a href="{{ route('insurance.settings.index', ['companyRoute' => $user->company_slug]) }}" 
                                   class="flex items-center p-3 rounded-xl hover:bg-gray-50 transition-colors duration-200 group">
                                    ...
                                    <span class="text-gray-700 group-hover:text-gray-900 font-medium">الإعدادات</span>
                                    <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 mr-auto rtl:mr-0 rtl:ml-auto" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/>
                                    </svg>
                                </a>
            ...
            <div class="space-y-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                        <svg class="w-4 h-4 text-gray-500 mr-2 rtl:mr-0 rtl:ml-2" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
                        </svg>
                        كلمة المرور الحالية
                    </label>
                    <input type="password" name="current_password" required 
                           class="w-full border border-gray-300 rounded-xl focus:ring-2 px-4 py-3" 
