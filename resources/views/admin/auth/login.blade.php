...
<head>
    ...
    <title>{{ t('admin.login', 'Login') }} - {{ t('admin.site_name', 'Site Name') }}</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="w-full max-w-lg">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-400">{{ t('admin.login', 'Login') }}</p>
            </div>
                ...
                <form method="POST" action="{{ route('admin.login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="{{ $isRtl ? 'mr-3' : 'ml-3' }} text-gray-300 text-sm">
                            {{ t('admin.remember_me', 'Remember Me') }}
                        </label>
                    </div>
            ...
            <div class="text-center text-gray-500 text-sm mt-6">
                <p>&copy; {{ date('Y') }} {{ t('admin.site_name', 'Site Name') }}. {{ t('admin.all_rights_reserved', 'All rights reserved') }}</p>
            </div>
        </div>
    </div>
</body>
