...
<head>
    ...
    <title>{{ t('auth.login') }} - {{ t('tow.service_dashboard') }}</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="w-full max-w-lg">
            ...
            <div class="bg-dark-800/80 backdrop-blur-xl rounded-2xl p-8 border border-gold-500/20 shadow-2xl">
                ...
                <form method="POST" action="{{ route('tow-service.login') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="text-center">
                        <p class="text-gray-400 text-sm">
                            ...
                            <a href="{{ route('tow-service.register') }}" class="text-gold-400 hover:text-gold-300 font-medium">
                                {{ t('auth.register') }}
                            </a>
                        </p>
                    </div>
